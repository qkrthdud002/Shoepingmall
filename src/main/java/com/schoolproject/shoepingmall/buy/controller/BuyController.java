...
public class BuyController {
    ...
    @PostMapping("/buy")
    public ResponseEntity<List<BoardListDTO>> buy(@RequestBody @Valid BuyInsertDTO buyInsertDTO) {
    ...
    public ResponseEntity<List<BoardListDTO>> buyDelete(@RequestBody @Valid BuyDeleteDTO buyDeleteDTO) {
